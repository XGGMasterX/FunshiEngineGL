...
public:
	...
	virtual void showDataComponent() override {
		...
		ImGui::SliderFloat("Xt", &componentTransform->getTranslatef()[0], -999.0f, 999.0f);
		ImGui::SliderFloat("Yt", &componentTransform->getTranslatef()[1], -999.0f, 999.0f);
		ImGui::SliderFloat("Zt", &componentTransform->getTranslatef()[2], -999.0f, 999.0f);
		...
		ImGui::Text("Scale");
		ImGui::SliderFloat("Xs", &componentTransform->getScalef()[0], -999.0f, 999.0f);
		ImGui::SliderFloat("Ys", &componentTransform->getScalef()[1], -999.0f, 999.0f);
		ImGui::SliderFloat("Zs", &componentTransform->getScalef()[2], -999.0f, 999.0f);
		...
		ImGui::Text("Rotate");
		ImGui::SliderFloat("Angulo", &componentTransform->getRotatef()[0], -999.0f, 999.0f);
		ImGui::SliderFloat("Xr", &componentTransform->getRotatef()[1], -999.0f, 999.0f);
		ImGui::SliderFloat("Yr", &componentTransform->getRotatef()[2], -999.0f, 999.0f);
		ImGui::SliderFloat("Zr", &componentTransform->getRotatef()[3], -999.0f, 999.0f);
