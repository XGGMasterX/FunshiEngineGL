...
public:
	...
	virtual void showDataComponent() override {
		...
		ImGui::Text("Rotate");
		ImGui::SliderFloat("Xr", &componentTransform->getRotatef()[0], -100.0f, 100.0f);
		ImGui::SliderFloat("Yr", &componentTransform->getRotatef()[1], -100.0f, 100.0f);
		ImGui::SliderFloat("Zr", &componentTransform->getRotatef()[2], -100.0f, 100.0f);
